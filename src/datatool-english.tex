...
\usepackage[colorlinks,
            ...
            pdftitle={English Localisation Support for datatool.sty}]{hyperref}
...
With the newer \cs{DTLsortwordlist}, this is performed once for each
item in the set to be sorted to allow for a faster character code
sort of a temporary sequence variable that stores both the original
and the transformed item. This allows the original item to be
restored afterwards.
